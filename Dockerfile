...
RUN wget https://github.com/emqx/emqx-rel/raw/master/deploy/docker/docker-entrypoint.sh && \
    wget https://github.com/emqx/emqx-rel/raw/master/deploy/docker/start.sh
